...
const Razonamiento = () => {
  const entrenamientos = [
    {
      entrenamientoTitle: 'Razonamiento (Starter Pack 300)',
      entrenamientoType1: 'Entrenamiento',
      entrenamientoType2: 'Razonamiento',
      entrenamientoDescription:
        'Entrenamiento 100% práctico para las pruebas de Razonamiento de EPSO (verbal, numérico y...',
      entrenamientoLink: '#',
    },
    {
      entrenamientoTitle: 'Razonamiento (Advanced Pack 600)',
      entrenamientoType1: 'Entrenamiento',
      entrenamientoType2: 'Razonamiento',
      entrenamientoDescription:
        'Entrenamiento 100% práctico para las pruebas de Razonamiento de EPSO (verbal, numérico y...',
    ...
    {
      entrenamientoTitle: 'Razonamiento (Ultimate Pack 1200)',
      entrenamientoType1: 'Entrenamiento',
      entrenamientoType2: 'Razonamiento',
      entrenamientoDescription:
        'Entrenamiento 100% práctico para las pruebas de Razonamiento de EPSO (verbal, numérico y...',

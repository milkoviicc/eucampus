...
const Navbar = () => {
  return (
    <div className="flex justify-between text-secondary h-[55px] text-[#222]">
      ...
      <div className="pt-[10px] flex-1 ml-25">
        <ul className="text-[14px] flex gap-8 items-center h-full leading-[40px]">
          {/* Cursos Dropdown */}
          <li className=" group">
            <a href="#" className="flex items-center gap-2 px-[10px] uppercase">
              Cursos <FontAwesomeIcon icon={faCaretDown} size="sm" className="w-[11]" />
            </a>
            <div className="absolute top-[55px] left-0 flex gap-8 pt-[50px] pb-[40px] px-[50px] bg-white shadow-lg border border-gray-200 w-full opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
          ...
          <li className="relative group">
            <a href="#" className="flex items-center gap-2 uppercase">
              Trabajar en la UE <FontAwesomeIcon icon={faCaretDown} size="sm" className="w-[11]" />
            </a>
      ...
      <div className="flex gap-3 pt-[10px] items-center uppercase text-[14px]">

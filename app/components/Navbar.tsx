          ...
          <div className="pt-[7px] flex-1 px-8 hidden xl:block">
            <ul className="text-[14px] flex gap-2 justify-evenly items-center h-full leading-[40px]">
              ...
              <li className="relative group">
                ...
                <div className="absolute pt-[10px] pb-[20px] px-5 top-full -left-72 flex gap-3 bg-white shadow-lg border border-gray-200 w-max opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <div className="py-2 grid grid-cols-3">
                    ...
                    <Link
                      href="/trabajar-en-la-ue/#practicos"
                      className="flex gap-2 px-4 py-2 text-lg text-accent hover:bg-gray-100 transition-colors"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
